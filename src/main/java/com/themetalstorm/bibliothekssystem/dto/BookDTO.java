...
public record BookDTO(Integer id, String name, String isbn, String publisher, Set<GenreDTO> genres, Set<AuthorDTO> authors, @DefaultValue(value = "1") int availableCopies, @DefaultValue(value = "1") int totalCopies) {
    public BookDTO(Book book){
        this( book.getId(), book.getName(), book.getIsbn(), book.getPublisher(),
